return {
    {
        ...
        config = function()
            ...
            wk.add( { "<Leader>td", function() neotest.run.run(vim.fn.expand("%")) end, desc = "Document", icon = { icon = "󰈙", color = "grey" } } )
            wk.add( { "<Leader>to",neotest.output_panel.toggle, desc = "Output", icon = { icon = "", color = "grey" } } )
