...
-- Map Alt+j to Down and Alt+k to Up in all modes
-- vim.keymap.set({ "n", "i", "v", "c" }, "<A-j>", "<Down>", { noremap = true, silent = true })
-- vim.keymap.set({ "n", "i", "v", "c" }, "<A-k>", "<Up>", { noremap = true, silent = true })
