...
alias cdbrext='cd $HOME/dev/code/eyeontext/breach-extractor'
alias cdportal-app='cd $HOME/dev/code/eyeontext/comp-wowool-portal-app'
alias cdportal-backend='cd $HOME/dev/code/eyeontext/comp-wowool-portal-backend-py'
alias cdportal-client='cd $HOME/dev/code/eyeontext/comp-wowool-portal-client-py'
alias cdportal-frontend='cd $HOME/dev/code/eyeontext/comp-wowool-portal-frontend-js'
